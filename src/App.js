    ...
    <Fragment>
      ...
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path="/home/daily-sales" render={() => <DashboardPage index={2} />} />
          <Route exact path="/home/sales-person-wise-report" render={() => <DashboardPage index={3} />} />
          <Route exact path="/home/product-wise-sales-report" render={() => <DashboardPage index={4} />} />
          <Route exact path="/home/retailer-wise-sales-report" render={() => <DashboardPage index={5} />} />
          <Route exact path="/home/retailer-wise-outstanding-report" render={() => <DashboardPage index={6} />} />
          <Route exact path="/home/sales-person-wise-outstanding-report" render={() => <DashboardPage index={7} />} />
          <Route exact path="/home/product-wise-outstanding-report" render={() => <DashboardPage index={8} />} />
