...
const Navbar = (props) => {
  ...
  return (
    <S.Wrapper>
      ...
      <S.SubHead onClick={() => history.push("/home/sales-person-wise-report")}>Sales-person wise Report</S.SubHead>
      <S.SubHead onClick={() => history.push("/home/product-wise-sales-report")}>Product wise</S.SubHead>
      <S.SubHead onClick={() => history.push("/home/retailer-wise-sales-report")}>Retailer wise Sales</S.SubHead>
      <S.SubHead onClick={() => history.push("/home/retailer-wise-outstanding-report")}>Retailer wise outstanding</S.SubHead>
      <S.SubHead onClick={() => history.push("/home/sales-person-wise-outstanding-report")}>Sales-person wise outstanding</S.SubHead>
