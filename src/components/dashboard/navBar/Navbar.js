...
const Navbar = () => {
    ...
    return (
        <S.Wrapper>
            ...
            <S.SubHead color={state.isSelected[0] ? "white" : ""} background={state.isSelected[0] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[1] ? "white" : ""} background={state.isSelected[1] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[2] ? "white" : ""} background={state.isSelected[2] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[3] ? "white" : ""} background={state.isSelected[3] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[4] ? "white" : ""} background={state.isSelected[4] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[5] ? "white" : ""} background={state.isSelected[5] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[6] ? "white" : ""} background={state.isSelected[6] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[7] ? "white" : ""} background={state.isSelected[7] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[8] ? "white" : ""} background={state.isSelected[8] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
            ...
            <S.SubHead color={state.isSelected[9] ? "white" : ""} background={state.isSelected[9] ? "#fd0167" : ""}
                       onClick={() => {
                           setState({
                               ...state,
